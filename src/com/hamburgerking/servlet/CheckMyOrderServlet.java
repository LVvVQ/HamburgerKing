...
@WebServlet("/checkMyOrderServlet")
public class CheckMyOrderServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Page<Order> page = orderService.findOrderByPage(currentPage, rows, uid);
        ResultInfo resultInfo = (ResultInfo) req.getAttribute("resultInfo");
