...
@WebServlet("/searchOrderByPageServlet")
public class SearchOrderByPageServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Page<Order> page = orderService.searchOrder(keyword, currentPage, rows);
