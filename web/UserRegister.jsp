...
<div class="container-fluid position-relative bg-white d-flex p-0">
    ...
    <div class="container-fluid">
        <form method="post" action="userRegisterServlet" id="form" enctype="multipart/form-data">
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="UserRegister.jsp" class="">
                                <h3 class="text-primary"><i class="fa fa-hashtag me-2"></i>注册</h3>
                            </a>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput" name="name" placeholder="账号" >
                        ...
                        <div class="form-floating mb-4">
                            <input type="password" class="form-control" id="ConfirmPassword" placeholder="确认密码" name="ConfirmPassword">
                            <label for="ConfirmPassword">确认密码</label>
                        </div>
                        <div class="form-floating mb-4">
                            <input type="file" class="form-control" id="avatar" placeholder="选择头像" name="avatar">
                        ...
                        <a  class="btn btn-primary py-3 w-100 mb-4" href="javascript:checkLogin()">提交</a>
