                  ...
                  <tbody>
                    ...
                    <tr>
                      <td data-label="Product" class="product-name">
                        ...
                        <div class="cart-product-img">
                          <img
                            src="static/picture/burger-07.png"
                            alt="cart-preview"
                          />
                        </div>
                        ...
                        <div class="cart-product-desc">
                          <h5 class="h5-sm">Smokey House Burger</h5>
                          <p class="p-sm">Magna donec and ipsum gravida</p>
                        </div>
                      </td>

                      <td data-label="Price" class="product-price">
                        <h5 class="h5-md">$8.95</h5>
                      </td>
                    ...
                    <tr class="last-tr">
                      <td data-label="Product" class="product-name">
                        ...
                        <div class="cart-product-img">
                          <img
                            src="static/picture/pizza-04.png"
                            alt="cart-preview"
                          />
                        </div>
                        ...
                        <!-- Description -->
                        <div class="cart-product-desc">
                          <h5 class="h5-sm">BBQ Chicken Pizza</h5>
                          <p class="p-sm">Magna donec and ipsum gravida</p>
                        </div>
                      </td>

                      <td data-label="Price" class="product-price">
                        <h5 class="h5-md">$27.00</h5>
                      </td>
                      <td data-label="Quantity" class="product-qty">
                        <input
                          class="qty"
          ...
          <!-- END CART TABLE -->
            ...
            <div class="col-lg-4">
              <div class="cart-checkout bg-lightgrey">
                ...
                <!-- Button -->
                <a href="#" class="btn btn-md btn-salmon tra-salmon-hover"
